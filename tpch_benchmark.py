...
class Benchmark:
    ...
    def __create_tables(self):
        commands = [
            ...
            "CREATE PROCEDURE `refresh_function2`(sf float) BEGIN declare i int default 1; declare iterations int default floor(1500 * sf); while i < iterations do delete from ORDERS where O_ORDERKEY = @i; delete from LINEITEM where L_ORDERKEY = @i; end while; END;"
        ]
        try:
